...
|---|---|---|
| **① 商談前に事前に情報収集** | **ペルソナ8（HR責任者）** | ペルソナ3（営業部長）、ペルソナ6（VP of Sales） |
| **② イベント参加後のデータ整理** | **ペルソナ1（スタートアップ創業者）、ペルソナ5（VC投資家）、ペルソナ7（コミュニティリーダー）** | 全ペルソナに共通 |
| **③ 日常的に（誕生日・タイムライン通知）** | **全ペルソナに共通** | 特にペルソナ2（コンサルタント）、ペルソナ4（フリーランス） |
| **④ 人物検索したいときに（採用候補者など）** | **ペルソナ8（HR責任者）** | ペルソナ1（スタートアップ創業者）、ペルソナ5（VC投資家）、ペルソナ7（コミュニティリーダー） |

---

## ユースケース①「商談前に事前に情報収集」の詳細設計

**ペルソナ8（HR責任者）** と **ペルソナ6（VP of Sales）** にとって、このユースケースは最も重要です。
...
**ペルソナ8（HR責任者）**、**ペルソナ5（VC投資家）**、**ペルソナ7（コミュニティリーダー）** にとって、このユースケースは最も重要です。
